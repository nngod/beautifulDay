...
peizhi2.addEventListener("click", function () {
  ...
  price.innerHTML = "2999 元";
  del.innerHTML = "3699 元";

  shop_pz.innerHTML = this.innerHTML;
  del1.innerHTML = del.innerHTML;
  jg.innerHTML = price.innerHTML;
  jg1.innerHTML = "总价: " + price.innerHTML;
...
peizhi1.addEventListener("click", function () {
  ...
  price.innerHTML = "2699 元";
  del.innerHTML = "3399 元";
...
color2.addEventListener("click", function () {
  ...
  color4.style.border = "1px solid #ccc";
  ...
  shop_co.innerHTML = this.innerHTML;
});
...
color4.addEventListener("click", function () {
  ...
  color4.style.border = "1px solid #FF6700";
  color4.style.color = "#FF6700";
  ...
  img1.src = "img/img16.jpg";
  img2.src = "img/img17.jpg";
  img3.src = "img/img18.jpg";
  img4.src = "img/img19.jpg";
  img5.src = "img/img20.jpg";
